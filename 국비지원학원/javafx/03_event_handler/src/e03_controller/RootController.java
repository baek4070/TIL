...
public class RootController implements Initializable {
	// fxml 파일에 등록된 요소의 타입과 fx:id가 변수명과 일치해야 한다.
...
//	@FXML private Button btn3;
	...
	// Controller 객체를 생성하고 initialize method를 호출
	@Override			//어디 fxml 인지 URL 	// 데이터 묶음 키 와 데이터 
	public void initialize(URL location, ResourceBundle resources) {
		System.out.println("initialize 메소드 호출");
