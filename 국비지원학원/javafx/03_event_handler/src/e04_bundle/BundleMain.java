...
/*
 * bundle - 여러가지 데이터의 묶음
 * java 에서 bundle 은 여러가지 타입의 데이터를 저장하는 Map
...
//		locale = new Locale("ja","JP");//일본
		...
		try {
			...
			// Button 도 Parent가 될 수 있음. 단. 내부에 요소를 담을수 없음
//			Parent btn = new Button("Hello JavaFX!");
//			Scene scene = new Scene(btn);//버튼도 장면의 요소가 될수있다  다만 안에 다른요소를 못담을 뿐 ! 
